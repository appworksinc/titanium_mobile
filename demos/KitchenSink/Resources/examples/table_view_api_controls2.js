...
tableview.addEventListener('click', function(e)
{
	...
	// Grab the child views of the row
    var children = row.children;
    if (null != children) {
    	for(var thisChild in children) {
    		row.remove(thisChild);
    	}
    	Ti.API.info("Sucessfully deleated all of the child controls for this row - the row should now be blank");
    } else {
    	Ti.API.info("No child controls available to remove!");
    }
});
