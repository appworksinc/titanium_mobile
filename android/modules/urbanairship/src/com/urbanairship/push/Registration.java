...
public class Registration {
	...
	public static void register(Context ctx, final APIDReceiver apidReceiver) {
	    ...
	    Log.d("app", "Registering without props");	    
		Properties props = new Properties(ctx);
		register(ctx, apidReceiver, props);
    }
	 ...
	 * @param apidReceiver Callback that accepts apid
	 */
	public static void register(Context ctx, final APIDReceiver apidReceiver, Properties props) { 
